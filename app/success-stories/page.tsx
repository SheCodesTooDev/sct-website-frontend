...
Our Success  Story     </p>
  ...
  {stories.map((story) => (
    <div key={story.id} className='p-4 border-2 w-1/4 flex-col justify-center items-center'>
      {story.photo && (
        <svg width="346" height="306" viewBox="0 0 346 306" fill="none" xmlns="http://www.w3.org/2000/svg">
          <defs>
          ...
          <image href={story.photo} x="0" y="0" width="346" height="306" clipPath={`url(#clip-path-${story.id})`} />
          <path 
