const EmpoweringSection = () => {
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen p-6 sm:p-4">
      ...
      <h1 className="text-2xl sm:text-4xl leading-tight text-center mt-40 sm:mt-60">
        Empowering Women,
        <br />
