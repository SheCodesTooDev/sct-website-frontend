   ...
   "
    >
      <div className="md:w-72 md:ml-10">
        <h4
          className="pl-16 mb-5 text-lg font-semibold
md:text-lg md:pl-10
"
        >
          Main
...
md:ml-5"
        >
          <li
            className="px-7 pb-6 text-sm text-gray-500
 md:px-4"
          >
          ...
          <li
            className="px-7 text-sm text-gray-500
md:px-4"
          >
 ...
 md:px-4"
      ...
      {/* <div className="md:w-72 md:ml-10">
        <h4
          className="pl-16 mb-5 text-lg font-semibold mt-10
    ...
    lg:-mt-8"
        ...
        <ul>
          <li
            className="pl-16 text-sm text-gray-500
      md:pl-5"
          >
