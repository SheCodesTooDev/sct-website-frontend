  ...
  return (
    <div className='flex justify-center flex-col items-center'>
      ...
      <p className='font-medium text-start text-base md:text-md mb-16  leading-loose text-black'>
        ...
        or 7 months through and online and in-person classes. Through a variety
        of courses related to computer programming, the participants learn about
        their desired topic or area. Beside teaching technical skills, we also
